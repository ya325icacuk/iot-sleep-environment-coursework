        ...
        table_html = """<table style="width: 100%; border-collapse: collapse; font-size: 1.5rem;">
            <thead>
                <tr style="border-bottom: 2px solid rgba(148, 163, 184, 0.2);">
                    <th style="text-align: left; padding: 1rem 1.3rem; color: #FFFFFF; font-weight: 600;">Condition</th>
                    ...
                    <th style="text-align: left; padding: 1rem 1.3rem; color: #FFFFFF; font-weight: 600;">Difference</th>
                </tr>
            </thead>
            <tbody>"""
        for row in rows_data:
            table_html += f"""
                <tr style="border-bottom: 1px solid rgba(148, 163, 184, 0.1);">
                    <td style="padding: 1rem 1.3rem; color: #F1F5F9; font-weight: 500;">{row["Condition"]}</td>
                    ...
                    <td style="padding: 1rem 1.3rem; color: #F1F5F9;">{row["Difference"]}</td>
                </tr>"""
